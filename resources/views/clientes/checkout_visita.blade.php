...
<div class="card">
    ...
    <div class="card-body">
            ...
            <form method="POST" action="{{route('clientes.guardar_checkout')}}" enctype="multipart/form-data">
                ...
                <br><br>
                <button type="submit" id="submit-button-guardar" name="accion" value="guardar_pedido" class="btn btn-primary">Guardar y Gestionar Pedido</button>
                <button type="submit" id="submit-button" class="btn btn-success">Finalizar Visita</button>
            </form>
