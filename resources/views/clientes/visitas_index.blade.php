...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="visitas" class="table table-striped table-sm">
            <thead>
            <tr>
                <th>Nombre</th>
                <th>Sector</th>
        ...
        "columns":[
            ...
            {data: 'sector'},
            {
                ...
                render: function(data) {
                    return moment(data, 'YYYY-MM-DD hh:mm').format('DD-MM-YYYY LT');
                }
            },
            {
                data: 'fecha_checkout',
