            ...
            <div class="box box-solid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="search-client-input" class="form-control" placeholder="Buscar cliente..." autocomplete="off" required>
                                    ...
                                    <label for="vendedor">Vendedor</label>
                                        <select class="form-control" id="vendedor_id" name="vendedor_id" required>
                                            @foreach ($vendedores as $vendedor)
                                                <option value="{{$vendedor->id}}" {{ ($user->id==$vendedor->id)?'selected':'' }}>{{$vendedor->name}}</option>
                                            @endforeach
                                        </select>
                                </div>
                                <div class="form-group col-md-6">
